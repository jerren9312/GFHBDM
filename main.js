...
let defaultViewMatrix = [0.99,-0.09,-0.16,0,0.14,0.95,0.27,0,0.12,-0.29,0.96,0,-0.01,-0.82,2.19,1];
...
async function main() {
    ...
    // Data already loaded via chunks above, now process it
    if (isPly(splatData)) {
